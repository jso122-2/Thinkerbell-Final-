# Copy of PRINGLES   2025 H1 Influencer Programme Talent Agreement KAIA KINGSLEY

InfluencerAgreementCOMPANY DATE OF AGREEMENT22/01/2025 BETWEEN Thinkerbell (ABN 99 618 397 658) of 261-265 Chalmers St, Redfern, NSW, 2016 (“Agency”)
 
AND Kaia Kingsley of Born Bred Talent of 210 Crown St, Darlinghurst NSW 2010 (“Influencer”) 
...
CLIENT Kellanova (ABN: 30 004 110 105) of Suite 801, Level 8/8 Central Ave, Eveleigh NSW 2015 BRAND Pringles PRODUCT Pringles BBQ, Pringles Japanese Sticky Teriyaki Flavour, Pringles Caribbean Spiced Chicken Flavour, Pringles Zesty Chilli & Lime Flavour, Pringles Sizzlin' Chipotle & Sour Cream Flavour CAMPAIGN Pringles 2025 H1 Influencer Programme 
ENGAGEMENT TERM 5.5 months (13 Jan 2025- 30 June 2025) from the date of this Agreement, plus any Rollover Term exercised under clause 3. 
WORK/S Attendance to a brand briefing immersion session and delivery of key content outputs as listed below.
The following materials will be produced by the Influencer across three spikes during the Usage Term.
3 x IG story sets (1 x story set to go live per spike)
3 x IG reels (1 x reel to go live per spike)
3 x TikTok videos (1 x video to go live per spike)
6wks of paid usage (2 weeks of paid usage for 3 spike)
5mos of ## EXCLUSIVITY

exclusivity A brief of the materials will be provided to the Agency for approval prior to commencement of producing the materials. 
...
TikTok [@kaiakingsley_]; and Instagram [@kaiakingsley].
...
PAID USAGE TERMS 6 weeks (2 weeks each for 3 spikes), plus any Rollover Term exercised under clause 3. The dates are subject to change depending on the live date of the content.
FEE A total of $18,000 + 15% ASF to be paid (total $20,125), excluding GST. 
The fee comprises of the following ## DELIVERABLES

deliverables:
3 x IG story sets - $3,000 3 x IG reels - $8,000 3 x TikTok videos - $2,500 4wks of paid usage - $2500 5mos of ## EXCLUSIVITY

exclusivity - $2000 ## PAYMENT TERMS

Payment Terms: Payment shall be made as follows: a fee of $6,000 + 15% ASF + GST (total of $6,900 + GST) will be paid within 30 days in three intervals once the delivered and accepted Work for each spike is first published in the Influencer’s social media channels. In any Rollover Term, $6,000 + 15% ASF + GST (total of $6,900 + GST) will be paid within 30 days once the delivered and accepted Work is first published in the Influencer’s social media channels for that Rollover Term.
OTHER CONSIDERATION As a part of the agreement, Agency will supply any relevant Pringles PR package and additional cans of Pringles (final amount to be determined at a later date). Agency will arrange for the delivery to arrive at the influencer’s home or preferred delivery address. 
INITIAL DELIVERY DATE Content live date to be discussed and agreed upon between Client, Influencer and Agency. 
CONTACT PERSON FOR EACH PARTY Thinkerbell Joy Liu, Earned Thinker 
joyliu@thinkerbell.com 
0406 187 333 Joanna Patridge, Lead Earned Thinker joannapartridge@thinkerbell.com 0402 664 343 Born Bred Talent Lucinda Boden, Talent Manager lucinda@bornbredtalent.com 0411 735 635 ## EXCLUSIVITY

EXCLUSIVITY ## EXCLUSIVITY

Exclusivity Terms: Talent agrees to be exclusive to Pringles and not to provide services to any competitor brand in Australia during the Term and for a total period of 5 months during the duration of their contracted Term (or any extension). This includes but is not limited to, producing, representing or appearing in content on social media featuring, or on behalf of any snack salty snack competitor brands including but not limited to Smith Chips, Doritos, Harvest Snaps, Red Rock Deli, Twisties, Kettle, Cheetos and Ritz.
## EXCLUSIVITY

Exclusivity Period: 5 months of ## EXCLUSIVITY
...
4.2 During the usage term, the Influencer agrees to grant Agency and Client a non-exclusive, royalty-free licence to use the ## DELIVERABLES

Deliverables (including associated intellectual property rights) solely for the Project and Brand, within the brand’s business operations. This licence is non-transferable, limited to the term of the agreement, and excludes modifications without prior approval:
...
9.4 Agency may terminate this Agreement on written notice if Influencer is involved in any controversies or does not meet the agreed upon expectations including but not limited to the below:
(a) is charged with or convicted of any criminal misconduct;
(b) becomes insolvent; 
(c) engages in serious social misconduct, engage or promote negative comments or interations, imply negative associations to the brand
(d) breaches ## EXCLUSIVITY

exclusivity or non-compete clauses; or
(e) fails to provide any Work at the agreed upon time or to the quality required by Agency and mutually agreed.
...
Signature of authorised representative __________________________________ ______________________________ Name of Witness Name and title of authorised representative Signed by Kaia Kingsley of Born Bred Talent in the presence of:
__________________________________ ______________________________ ## SIGNATURES

Signature of Witness ## SIGNATURES

Signature of Influencer __________________________________ ______________________________ Name of Witness Name of Influencer 

# GWM   WSL CarPool Jack Robinson Agreement DRAFT
...
CLIENT GWM Australia Pty Ltd (ABN 69 617 781 049) of 1/745 Springvale Rd, Mulgrave Melbourne VIC 3170, Australia BRAND GWM PRODUCT
“The CarPool” (Cannon Alpha Plug-In Hybrid Electric Vehicle) 
CAMPAIGN WSL Event Sponsorship ENGAGEMENT TERM 2 months (29 April - 1-4 July 2025), plus any Rollover Term exercised under clause 3. The dates are subject to change depending on the live date of the content. Influencer should supply a copy of the Work once approved, to the Agency, for usage in paid media. 
...
0452 609 483 GP Sports Management Mike Regan, Sports Talent Manager mdr@gpsportsmanagement.com 
+1 949 444 6840 ## EXCLUSIVITY

EXCLUSIVITY ## EXCLUSIVITY

Exclusivity Terms: Talent agrees to be exclusive to GWM and not to provide services to any competitor brand in Australia during the duration of their contracted Term (or any extension). This includes but is not limited to, producing, representing or appearing in content on social media on behalf of any competitors including but not limited to Tesla, BYD, MG Motor, LDV Group, JAC Motors, Chery Automobile, Toyota, Ford, Mitsubishi, Nissan, Land Rover, and Range Rover.
## EXCLUSIVITY

Exclusivity Period: 29 April - 1-4 July 2025 (depending on live date)
Other ## EXCLUSIVITY

Exclusivity Terms (if any): Talent will advise Thinkerbell and GWM of any ongoing services they provide or will provide during the Term to any third party and make best efforts to ensure that such services do not unduly impact the exclusive relationship with GWM or the provision of services under this Agreement. Talent remains entirely exclusive to GWM from any other competitor brands for the duration of the Term. Further, Talent must advise Thinkerbell and GWM of any ongoing services they provide to any third party to ensure that it does not impact the exclusive relationship with GWM or the provision of services under this Agreement. 
## SPECIAL CONDITIONS
...
(a) #sponsored;
(b) #ad; or 
(c) #GWMAustralia #CannonAlphaPHEV 7. ## EXCLUSIVITY
...
12.10 ​​The Talent represents and warrants that, as of the date of this Agreement and at all times throughout the term of this Agreement, they have not been, and are not currently, subject to any criminal or driving-related legal charges, whether historical, present, or pending. The Talent further agrees to immediately notify the Company in writing of any such charges or legal proceedings that may arise during the term of this Agreement. Any breach of this representation and warranty may result in immediate ## TERMINATION

termination of this Agreement and may subject the Talent to legal liability, at the sole discretion of the Company.
 
EXECUTED AS AN AGREEMENT:
Signed for GWM Australia by Thinkerbellby its duly authorised representativein the presence of:
__________________________________ ______________________________ ## SIGNATURES

Signature of Witness ## SIGNATURES

Signature of authorised representative __________________________________ ______________________________ Name of Witness Name and title of authorised representative Signed for Jack Robinson by Mike Regan in the presence of:
__________________________________ ______________________________ ## SIGNATURES
